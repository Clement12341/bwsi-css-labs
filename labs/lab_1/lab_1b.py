...
def request_sanitized_operation(prompt: str) -> str:
    """
    Function that requests an operation input from the user and sanitizes it to ensure it's valid.

    Args:
        prompt (str): The prompt to display to the user.

    Returns:
        str: The sanitized operation input from the user.
    """
...
def main():
    ...
    num1 = float(request_sanitized_input("Enter the first number: "))
    num2 = float(request_sanitized_input("Enter the second number: "))
